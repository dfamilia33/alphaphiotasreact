...
Make sure your gatsby version is the following:

```
Gatsby CLI version: 2.12.22
Gatsby version: 2.22.6
```
...
```
**Note:** If using **WSL2** you **MUST** clone into your Ubuntu file system. If using VS Code you can open a remote connection to your repo located in your WSL2 Ubuntu file structure.
